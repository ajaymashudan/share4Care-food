...
$name=$_SESSION['name'];
$city = isset($_POST['city']) ? $_POST['city'] : ''; // Default to an empty string if 'city' is not set
$ch=curl_init();
...
$Did = isset($_POST['Did']) ? $_POST['Did'] : ''; // Default to an empty string if 'Did' is not set
